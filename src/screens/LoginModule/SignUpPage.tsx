...
export default function SignUpPage() {
  ...
  const [searchParams] = useSearchParams(); // For handling query parameters

  // Retrieve the registration token from the URL (if it exists)
  React.useEffect(() => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (valid) {
      try {
        await signupUser({ firstName, lastName, email, password, captchaToken }, signupToken); // Send token if it exists
